...
import java.lang.Double;import java.lang.Long;import java.lang.Math;import java.lang.Override;import java.lang.String;import java.lang.System;import java.util.ArrayList;
...
public class TableActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(
                R.layout.results_activity);

        ///// BUTTON

        Button BTNShowMainActivity = (Button) findViewById(
                R.id.showMainActivity);
        ...
        resultsActivityMenuButton = (TextView) findViewById(
                R.id.resultsActivityMenuButton);
        ...
        myTable = (TableLayout) findViewById(
                R.id.myTable);
...
//            tvCenter.setGravity(Gravity.CENTER);
    ...
    public void showMenu(View v) {
        ...
        mi.inflate(
                R.menu.results_menu, pm.getMenu());
        pm.show();
    }
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
//            case
// R.id.results_populate_examples:
//                System.out.println("Populate examples");
//                return true;
//            case
// R.id.results_remove_examples:
